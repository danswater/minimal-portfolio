    ...
    return (
      <div className="contribute">
        <div className="wrap">
          ...
          <ul id="team">
            <li><a title="(Early version) Ring Rob Concierge is Robinsons Unit Owners’ online service site where a comprehensive menu of services is made available to answer your every need with just a click away." href="http://ringrobconcierge.com"><img className="avatar hoverZoomLink" src={Early} /></a></li>
